...
namespace putils {
	...
	public:
		...
		using is_copyable = std::integral_constant<bool, ConstructStrategy == construct_type::copy || ConstructStrategy == construct_type::copy_and_move>;
		using is_movable = std::integral_constant<bool, ConstructStrategy == construct_type::move || ConstructStrategy == construct_type::copy_and_move>;
	...
	public:
		...
		function(function<F, S, C> const &) = delete;
		template<typename F, size_t S, construct_type C>
		function(function<F, S, C> &) = delete;
		template<typename F, size_t S, construct_type C>
		function(function<F, S, C> &&) = delete;
		template<typename F, size_t S, construct_type C>
		function & operator=(function<F, S, C> const &) = delete;
		template<typename F, size_t S, construct_type C>
		function & operator=(function<F, S, C> &) = delete;
		template<typename F, size_t S, construct_type C>
		function & operator=(function<F, S, C> &&) = delete;
		template<typename F, size_t S, construct_type C>
		void assign(function<F, S, C> const &) = delete;
		template<typename F, size_t S, construct_type C>
		void assign(function<F, S, C> &) = delete;
		template<typename F, size_t S, construct_type C>
		void assign(function<F, S, C> &&) = delete;
...
namespace putils::detail {
	...
	struct function_traits<
		putils::function<R(Args...), Size>> : std::true_type {
